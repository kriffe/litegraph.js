(function () {
  ...
  GraphicsImage.prototype.onDrawBackground = function (ctx) {
    if (this.img && this.size[0] > 5 && this.size[1] > 5) { ctx.drawImage(this.img, 0, 0, this.size[0], this.size[1]) }
  }

  GraphicsImage.prototype.onExecute = function () {
    if (!this.img) { this.boxcolor = '#000' }
    if (this.img && this.img.width) { this.setOutputData(0, this.img) } else		{ this.setOutputData(0, null) }
  ...
  ColorPalette.prototype.onExecute = function () {
    ...
    if (this.properties.colorA != null) { c.push(hex2num(this.properties.colorA)) }
    if (this.properties.colorB != null) { c.push(hex2num(this.properties.colorB)) }
    if (this.properties.colorC != null) { c.push(hex2num(this.properties.colorC)) }
    if (this.properties.colorD != null) { c.push(hex2num(this.properties.colorD)) }
    ...
    var result = [0, 0, 0]
    if (f == 0) { result = c[0] } else if (f == 1) { result = c[ c.length - 1] } else	{
  ...
  ImageFrame.prototype.onDrawBackground = function (ctx) {
    if (this.frame) { ctx.drawImage(this.frame, 0, 0, this.size[0], this.size[1]) }
  }
...
*/
  ...
  ImageFade.prototype.onExecute = function () {
    ...
    if (fade == null) { fade = this.properties['fade'] } else		{ this.properties['fade'] = fade }
  ...
  ImageCrop.prototype.onDrawBackground = function (ctx) {
    ...
    if (this.canvas) { ctx.drawImage(this.canvas, 0, 0, this.canvas.width, this.canvas.height, 0, 0, this.size[0], this.size[1]) }
  }
  ...
  ImageVideo.prototype.onExecute = function () {
    ...
    if (this.properties.url != this._video_url) { this.loadVideo(this.properties.url) }
  ...
  ImageVideo.prototype.playPause = function () {
    ...
    if (this._video.paused) { this.play() } else		{ this.pause() }
  }
...
ImageWebcam.prototype.onExecute = function () {
  if (this._webcam_stream == null && !this._waiting_confirmation) { this.openStream() }
  ...
  ImageWebcam.prototype.onDrawBackground = function (ctx) {
    if (this.flags.collapsed || this.size[1] <= 20 || !this.properties.show) { return }
