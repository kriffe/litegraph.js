...
(function () {
  ...
  WidgetButton.prototype.onDrawForeground = function (ctx)	{
    ...
    if (this.properties.text || this.properties.text === 0)	{
      ...
      if (this.properties.font) { ctx.font = this.properties.font }
  ...
  WidgetKnob.prototype.onMouseDown = function (e)	{
    ...
    if (e.canvasY - this.pos[1] < 20 || LiteGraph.distance([e.canvasX, e.canvasY], [this.pos[0] + this.center[0], this.pos[1] + this.center[1]]) > this.radius) { return false }
  ...
  WidgetKnob.prototype.onWidget = function (e, widget)	{
    if (widget.name == 'increase') { this.onPropertyChanged('size', this.properties.size + 10) } else if (widget.name == 'decrease') { this.onPropertyChanged('size', this.properties.size - 10) }
  }

  WidgetKnob.prototype.onPropertyChanged = function (name, value)	{
    if (name == 'wcolor') { this.properties[name] = value } else if (name == 'size')		{
  ...
  WidgetHSlider.prototype.onPropertyChanged = function (name, value)	{
    if (name == 'wcolor') { this.properties[name] = value } else			{ return false }
    return true
  }
  ...
  WidgetText.prototype.onDrawForeground = function (ctx)	{
    ...
    if (typeof (this.str) === 'string')		{
      ...
      for (var i in lines) { ctx.fillText(lines[i], this.properties['align'] == 'left' ? 15 : this.size[0] - 15, fontsize * -0.15 + fontsize * (parseInt(i) + 1)) }
    }
  ...
  WidgetText.prototype.onExecute = function ()	{
    var v = this.getInputData(0)
    if (v != null) { this.properties['value'] = v } else			{ this.properties['value'] = '' }
    this.setDirtyCanvas(true)
  }
  ...
  WidgetText.prototype.onWidget = function (e, widget)	{
    if (widget.name == 'resize') { this.resize() } else if (widget.name == 'led_text')		{
